...
export function CrimeLocationList({ className }: CrimeLocationListProps) {
    ...
    const locationData = useMemo(() => {
        const locations = [
            { name: 'Penyelundupan', cases: 51905 },
            { name: 'Penipuan', cases: 1091 },
            { name: 'Perampokan', cases: 198 },
            { name: 'KDRT', cases: 712 },
            { name: 'Pembunuhan', cases: 177 },
            { name: 'Jalan Raya', cases: 856 },
            { name: 'Rumah', cases: 2145 },
            { name: 'Sekolah', cases: 234 },
            { name: 'Kantor', cases: 445 },
            { name: 'Pasar', cases: 678 }
        ]
    ...
    const totalCases = locationData.reduce((sum, location) => sum + location.cases, 0)
