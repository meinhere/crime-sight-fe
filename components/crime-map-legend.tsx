    ...
    return (
        <div className="absolute bottom-4 left-4 bg-white rounded-lg shadow-lg border border-gray-200 p-4 z-[1000]">
            <div className="flex items-center mb-3">
                ...
                <h4 className="font-semibold text-black">Tingkat Bahaya</h4>
            </div>

            <div className="space-y-3">
                <div className="flex items-center text-sm">
                    <div className="w-4 h-4 bg-red-500 rounded-full mr-3 border-2 border-red-600"></div>
                    <div>
                ...
                <div className="flex items-center text-sm">
                    <div className="w-4 h-4 bg-yellow-500 rounded-full mr-3 border-2 border-yellow-600"></div>
                    <div>
                ...
                <div className="flex items-center text-sm">
                    <div className="w-4 h-4 bg-green-500 rounded-full mr-3 border-2 border-green-600"></div>
                    <div>
            ...
            <div className="pt-3 mt-3 border-t border-gray-200">
                <div className="text-xs text-gray-500">
                    Klik area berwarna untuk detail
                </div>
            </div>
        </div>
    )
